...
import { ConnectedUser } from "@/app/types/User"
...
function Dashboard({ user }: DashboardProps) {
    const isFacebookConnected = user.facebookConnected;
    ...
    return (
        <>
            <div className='mb-2 flex items-center max-sm:flex-col'>
                <h1 className='text-2xl max-sm:text-left'>Dashboard</h1>
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex justify-center gap-2 max-sm:flex-col">
                            <Link 
                                type="button"
                                href="/main/post"
                                className='flex items-center gap-2 py-3 sm:px-4 px-2 rounded-md bg-[#10b981] text-white cursor-pointer max-sm:justify-center'
                            >
                                < IoAddSharp size={20} />
                                Creer un post
                            </Link>
